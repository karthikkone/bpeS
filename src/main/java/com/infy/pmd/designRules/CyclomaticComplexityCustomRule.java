 ...
 */
public class CyclomaticComplexityCustomRule extends AbstractApexRule {
    ...
    public CyclomaticComplexityCustomRule() {
        ...
        if (ApexClassMetricKey.WMC.supports(node)) {
            ...
            if (classWmc >= getProperty(CLASS_LEVEL_DESCRIPTOR)) {
               ...
               // addViolation(data, node, messageParams);
                ...
                System.out.println(classWmc);
                System.out.println(classHighest);
        ...
        if (cyclo >= getProperty(METHOD_LEVEL_DESCRIPTOR)) {
          ...
          /*  addViolation(data, node, new String[]{opType,
            ...
            */
            ...
            System.out.println(node.getQualifiedName().getOperation());
